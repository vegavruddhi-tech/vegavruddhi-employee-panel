...
const GOOGLE_CLIENT_ID =
  '175231524136-39m136pat1dpous6u9eijhfulpmpms1i.apps.googleusercontent.com';
...
export default function Login() {
  ...
  const onCredential = async (response) => {
    setLoading(true);
    const API_BASE = 'https://vegavruddhi-employee-panel.vercel.app';
    try {
    ...
    <>
      ...
      <div
        style={{
          ...
          minHeight: '100vh',
          background:
            'linear-gradient(135deg, #071a0f 0%, #0f3320 50%, #1a5c38 100%)',
          display: 'flex',
          alignItems: 'center',
      ...
      >
        ...
        >
          ...
          >
            Sign in with your registered Google account to access the employee
            portal.
          </p>
          ...
          <div
            style={{
              ...
              background: '#f0f7f3',
              borderRadius: 10,
              borderLeft: '3px solid #1a4731',
              textAlign: 'left',
            }}
          >
            <p style={{ fontSize: 12, color: '#4a7060', lineHeight: 1.6 }}>
              Use the{' '}
              <strong style={{ color: '#1a4731' }}>
                email address you provided
              </strong>{' '}
              during registration (your joining email ID).
            </p>
          </div>
